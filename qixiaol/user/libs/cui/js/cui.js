+function(t) {
    ...
    "use strict";
    t(document).on("click", ".ajax-get", function() {
        var e, i = this;
        return t(this).hasClass("confirm") && !confirm("确认要执行该操作吗?") ? !1 :(((e = t(this).attr("href")) || (e = t(this).attr("url"))) && (t(this).addClass("disabled").attr("autocomplete", "off").prop("disabled", !0), 
        t.get(e).success(function(e) {
            if (void 0 == e.code) alert(e), t(i).removeClass("disabled").prop("disabled", !1); else if (1 == e.code) {
                if (e.url && !t(i).hasClass("no-refresh")) var o = e.msg + " 页面即将自动跳转~"; else var o = e.msg;
            ...
            } else 1 == e.login ? t("#login-modal").modal() :t.alertMessager(e.msg, "danger"), 
            setTimeout(function() {
                t(i).removeClass("disabled").prop("disabled", !1);
            }, 2e3);
        }).error(function(e) {
            alert(e.responseText), t(i).removeClass("disabled").prop("disabled", !1);
        })), !1);
    });
}(jQuery), +function(t) {
    "use strict";
    t(document).on("click", ".ajax-post", function() {
        var e, i, o, s = t(this).attr("target-form"), n = this, a = !1;
        if ("submit" == t(this).attr("type") || (e = t(this).attr("href")) || (e = t(this).attr("url"))) {
            if (o = t("." + s), "true" === t(this).attr("hide-data")) o = t(".hide-data"), i = o.serialize(); else {
            ...
            t(n).addClass("disabled").attr("autocomplete", "off").prop("disabled", !0), t.post(e, i).success(function(e) {
                if (void 0 == e.code) alert(e), t(n).removeClass("disabled").prop("disabled", !1); else if (1 == e.code) {
                    if (e.url && !t(n).hasClass("no-refresh")) var i = e.msg + " 页面即将自动跳转~"; else var i = e.msg;
                    t.alertMessager(i, "success"), setTimeout(function() {
                        return t(n).hasClass("no-refresh") ? !1 :void (e.url && !t(n).hasClass("no-forward") ? location.href = e.url :location.reload());
                    }, 2e3);
                } else t.alertMessager(e.msg, "danger"), setTimeout(function() {
                    t(n).removeClass("disabled").prop("disabled", !1);
                }, 2e3), t(".reload-verify").length > 0 && t(".reload-verify").click();
            }).error(function(e) {
                alert(e.responseText), t(n).removeClass("disabled").prop("disabled", !1);
            });
        }
        return !1;
    });
    ...
    t.alertMessager = function(e, i, o) {
        i = i ? i :"danger";
        var s = '<div class="growl" style="top: 50px;left: 0;right:0;margin:0 auto;"><div class="alert alert-full alert-dismissable alert-' + i + '"><button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>' + e + "</div></div>";
        t(".growl").remove(), t("body").prepend(s), setTimeout(function() {
            t(".growl").remove();
        }, o ? o :2e3);
    };
}(jQuery), +function(t) {
    ...
    var i = function(e, o) {
        this.cleanWhitespace(e), this.row = 0, this.rownum = 1, this.elements = [], this.element = e, 
        this.albumWidth = t(e).width(), this.images = t(e).children(), this.options = t.extend({}, i.DEFAULTS, o), 
        t(window).on("resize", t.proxy(this.handleResize, this)), this.processImages();
    };
    i.VERSION = "3.3.1", i.TRANSITION_DURATION = 350, i.DEFAULTS = {
        ...
        this.row = 0, this.rownum = 1, this.elements = [], this.albumWidth = t(this.element).width(), 
        this.images = t(this.element).children(), this.processImages();
        ...
        this.images.each(function(i) {
            ...
            e.elements.push([ this, r, l ]), e.row += r + e.options.padding, e.row > e.albumWidth && e.elements.length && (e.resizeRow(e.row - e.options.padding), 
            e.row = 0, e.elements = [], e.rownum += 1), e.images.length - 1 == i && e.elements.length && (e.resizeRow(e.row), 
            e.row = 0, e.elements = [], e.rownum += 1);
        });
    }, i.prototype.resizeRow = function(e) {
        for (var i = this.options.padding * (this.elements.length - 1), o = this.albumWidth - i, s = o / (e - i), n = i, a = (e < this.albumWidth, 
        0); a < this.elements.length; a++) {
    ...
    var a = /\+/g, r = t.cookie = function(s, a, l) {
        if (void 0 !== a && !t.isFunction(a)) {
            if (l = t.extend({}, r.defaults, l), "number" == typeof l.expires) {
                var h = l.expires, d = l.expires = new Date();
                d.setTime(+d + 864e5 * h);
            }
        ...
        for (var c = s ? void 0 :{}, p = document.cookie ? document.cookie.split("; ") :[], f = 0, u = p.length; u > f; f++) {
            var g = p[f].split("="), m = i(g.shift()), v = g.join("=");
            if (s && s === m) {
                c = n(v, a);
                break;
            }
            s || void 0 === (v = n(v)) || (c[m] = v);
        }
        return c;
    };
    ...
    t.fn.lazyload = function(n) {
        function a() {
            ...
            l.each(function() {
                var i = t(this);
                if (!h.skip_invisible || i.is(":visible")) if (t.abovethetop(this, h) || t.leftofbegin(this, h)) ; else if (t.belowthefold(this, h) || t.rightoffold(this, h)) {
        ...
        return n && (o !== n.failurelimit && (n.failure_limit = n.failurelimit, delete n.failurelimit), 
        o !== n.effectspeed && (n.effect_speed = n.effectspeed, delete n.effectspeed), t.extend(h, n)), 
        r = h.container === o || h.container === e ? s :t(h.container), 0 === h.event.indexOf("scroll") && r.bind(h.event, function() {
            return a();
        }), this.each(function() {
            var e = this, i = t(e);
            e.loaded = !1, i.attr("src") !== o && i.attr("src") !== !1 || i.is("img") && i.attr("src", h.placeholder), 
            i.one("appear", function() {
                if (!this.loaded) {
                    ...
                    t("<img />").bind("load", function() {
                        ...
                        i[h.effect](h.effect_speed), e.loaded = !0;
        ...
        var a;
        return a = n.container === o || n.container === e ? (e.innerHeight ? e.innerHeight :s.height()) + s.scrollTop() :t(n.container).offset().top + t(n.container).height(), 
        a <= t(i).offset().top - n.threshold;
    }, t.rightoffold = function(i, n) {
        var a;
        return a = n.container === o || n.container === e ? s.width() + s.scrollLeft() :t(n.container).offset().left + t(n.container).width(), 
        a <= t(i).offset().left - n.threshold;
    }, t.abovethetop = function(i, n) {
        var a;
        return a = n.container === o || n.container === e ? s.scrollTop() :t(n.container).offset().top, 
        a >= t(i).offset().top + n.threshold + t(i).height();
    }, t.leftofbegin = function(i, n) {
        var a;
        return a = n.container === o || n.container === e ? s.scrollLeft() :t(n.container).offset().left, 
        a >= t(i).offset().left + n.threshold + t(i).width();
    ...
    "use strict";
    t.fn.pin = function(e) {
        var i = 0, o = [], s = !1, n = t(window);
        e = e || {};
        var a = function() {
            for (var i = 0, a = o.length; a > i; i++) {
                var r = o[i];
                if (e.minWidth && n.width() <= e.minWidth) r.parent().is(".pin-wrapper") && r.unwrap(), 
                r.css({
                    width:"",
                    left:"",
                    top:"",
                    position:""
                }), e.activeClass && r.removeClass(e.activeClass), s = !0; else {
                    s = !1;
                    var l = e.containerSelector ? r.closest(e.containerSelector) :t(document.body), h = r.offset(), d = l.offset(), c = r.offsetParent().offset();
                    ...
                    r.data("pin", {
                        pad:p,
                        from:(e.containerSelector ? d.top :h.top) - p.top,
                        to:d.top + l.height() - r.outerHeight() - p.bottom,
                        end:d.top + l.height(),
                        parentTop:c.top
                    }), r.css({
                        width:r.outerWidth()
            ...
            if (!s) {
                ...
                for (var a = [], r = 0, l = o.length; l > r; r++) {
                    var h = t(o[r]), d = h.data("pin");
                    if (d) {
                        a.push(h);
                        var c = d.from - d.pad.bottom, p = d.to - d.pad.top;
                        c + h.outerHeight() > d.end ? h.css("position", "") :i > c && p > i ? (!("fixed" == h.css("position")) && h.css({
                            left:h.offset().left,
                            top:d.pad.top
                        }).css("position", "fixed"), e.activeClass && h.addClass(e.activeClass)) :i >= p ? (h.css({
                            left:"",
                            top:p - d.parentTop + d.pad.top
                        }).css("position", "absolute"), e.activeClass && h.addClass(e.activeClass)) :(h.css({
                            position:"",
                            top:"",
                            left:""
                        }), e.activeClass && h.removeClass(e.activeClass));
                    }
                }
                o = a;
            }
    ...
    t("body").delegate(".nav-close .close", "click", function() {
        ...
        e && (t(e).hasClass("active") && (t(this).closest("li").prev().addClass("active"), 
        t(t(this).closest("li").prev().find("a").attr("href")).removeClass("fade").addClass("active")), 
        t(e).remove() && t(this).closest("li").remove());
    });
}(jQuery), +function(t) {
    "use strict";
    var e = function() {
    ...
    e || t("input.form-control").show(function() {
        ...
        t(this).val(""), t(this).val(t(this).val());
    }).blur(function() {
    ...
    function e() {
        ...
        this._$document = t(document), this._$window = t(window), this._$body = t(document.body), 
    ...
    function i(e) {
        ...
        this._targetImage = e, this._$body = t(document.body);
    }
    e.prototype.listen = function() {
        this._$body.on("click", '[data-action="zoom"]', t.proxy(this._zoom, this));
    }, e.prototype._zoom = function(e) {
        var o = e.target;
        if (o && "IMG" == o.tagName && !this._$body.hasClass("zoom-overlay-open")) return e.metaKey || e.ctrlKey ? window.open(e.target.getAttribute("data-original") || e.target.src, "_blank") :void (o.width >= t(window).width() - i.OFFSET || (this._activeZoomClose(!0), 
        this._activeZoom = new i(o), this._activeZoom.zoomImage(), this._$window.on("scroll.zoom", t.proxy(this._scrollHandler, this)), 
        this._$document.on("keyup.zoom", t.proxy(this._keyHandler, this)), this._$document.on("touchstart.zoom", t.proxy(this._touchStart, this)), 
        ...
        this._activeZoom && (t ? this._activeZoom.dispose() :this._activeZoom.close(), this._$window.off(".zoom"), 
        this._$document.off(".zoom"), document.removeEventListener("click", this._boundClick, !0), 
        ...
        t.preventDefault ? t.preventDefault() :event.returnValue = !1, "bubbles" in t ? t.bubbles && t.stopPropagation() :t.cancelBubble = !0, 
        ...
        Math.abs(e.touches[0].pageY - this._initialTouchPosition) > 10 && (this._activeZoomClose(), 
        ...
        this._targetImageWrap = document.createElement("div"), this._targetImageWrap.className = "zoom-img-wrap", 
        this._targetImage.parentNode.insertBefore(this._targetImageWrap, this._targetImage), 
        this._targetImageWrap.appendChild(this._targetImage), t(this._targetImage).addClass("zoom-img").attr("data-action", "zoom-out"), 
        this._overlay = document.createElement("div"), this._overlay.className = "zoom-overlay", 
        document.body.appendChild(this._overlay), this._calculateZoom(), this._triggerAnimation();
        ...
        a > e && n > o ? this._imgScaleFactor = s :l > r ? this._imgScaleFactor = n / o * s :this._imgScaleFactor = a / e * s;
        ...
        this._overlay.parentNode.removeChild(this._overlay), this._$body.removeClass("zoom-overlay-transitioning"));
    }, t(function() {
        new e().listen();
    });
}(jQuery);